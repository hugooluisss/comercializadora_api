<div style="background: #EAEAEA; padding: 50px;">
    <div style="width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 40px; min-height: 300px; background: white;">
            ...
            <p style="text-align: center"><b>¡¡¡ Hemos entregado tu pedido con No. {{$order->id}} !!!</b></p>
            <p style="text-align: center">Nuestro repartidor ha indicado que tu pedido ha sido entregado.</p>
